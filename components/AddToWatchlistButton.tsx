  ...
  return (
    <button
      ...
      style={{
        ...
        gap: 6,
        padding: '6px 12px',
        background: isWatching ? 'rgba(6,182,212,0.06)' : 'transparent',
        border: `1px solid ${isWatching ? 'rgba(6,182,212,0.2)' : 'rgba(255,255,255,0.08)'}`,
        borderRadius: 2,
        color: isWatching ? '#06b6d4' : state === 'loading' ? '#1e4d5c' : '#7ec8d8',
        fontSize: 10,
